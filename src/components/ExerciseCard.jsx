...
function ExerciseCard({ exercise, action }) {
  ...
  return (
    <div className="bg-[#cbf08c] :h-[24vh] w-[32vh] flex flex-col gap-2 justify-between rounded-xl rounded-br-none drop-shadow-md">
      ...
      <div
        onClick={() => action(_id)}
        className="flex ml-auto cursor-pointer bg-[#cbf08c] hover:bg-red-500 pt-4 pb-2 pl-4 pr-1 rounded-tl-full"
      >
        <svg
